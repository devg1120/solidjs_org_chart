  ...
  return (
    <div style={{ width: "360px", "border-left": "1px solid #e2e2e2", "background-color": "#ffffff", display: "flex", "flex-direction": "column" }}>
      ...
      <footer style={{ padding: "16px" }}>
        <form onSubmit={props.onSendMessage} style={{ display: "flex", "flex-direction": "column", border: "1px solid #868686", "border-radius": "8px", overflow: "hidden", background: "#ffffff" }}>
